                ...
                <div class="tab-content">
                        ...
                        <form class="form-horizontal" role="form" method="post">
                            ...
                            <div class="form-group">
                                <div class="col-sm-offset-2 col-sm-10">
                                    <button class="btn btn-default" onclick="login.check()" type="button">登录</button>
                    ...
                    <div class="tab-pane" id="panel-466221">
                        <form class="form-horizontal" role="form" method="post">
                            ...
                            <div class="form-group">
                                <div class="col-sm-offset-2 col-sm-10">
                                    <button type="button" class="btn btn-default" onclick="register.check()">注册</button>
                                </div>
                            </div>
                        </form>
                    </div>
    ...
    var login = {
        check : function() {
            ...
            if(email) {
                ...
                if(!password) {
                    dialog.error('用户名和密码不可为空');
                }else{
                    dialog.error('用户名不可为空');
                }
            }
        }
    };
